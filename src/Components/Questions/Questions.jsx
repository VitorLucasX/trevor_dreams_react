        ...
        <div className="secContainer grid" data-aos="fade-up">
            <div className="accordion grid">
                <Accordion title="How do I choose the right travel destination for me?"
                 desc="Consider your interest, budget, desired
                 experiences, and the type of
                 environment you enjoy. Research destinations that
                 align with your 
                ...
                <Accordion title="How can I find budget-friendly travel options and deals?"
                 ...
                 flexible with your travel dates can also help you ifnd better deals." 
                 active={active} 
                 setActive={setActive}
                 />
